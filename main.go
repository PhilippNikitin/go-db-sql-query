...
func main() {
	...
	newClient := Client{
		FIO:      "Test",           // укажите ФИО
		Login:    "testlogin",      // укажите логин
		Birthday: "01.01.1900",     // укажите день рождения
		Email:    "test@yandex.ru", // укажите почту
	}
...
func insertClient(db *sql.DB, client Client) (int64, error) {
	...
	return insertedId, nil // вместо 0 верните идентификатор добавленной записи
}
